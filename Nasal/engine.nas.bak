...
var hobbsmeter_engine_110hp = aircraft.timer.new("/sim/time/hobbs/engine", 60, 1);
...
init_hobbs_meter(0, hobbsmeter_engine_110hp);

var update_hobbs_meter = func {
    # in seconds
    var hobbs_110hp = getprop("/sim/time/hobbs/engine") or 0.0;
    # This uses minutes, for testing
    #hobbs = hobbs / 60.0;
    # in hours
    hobbs = (hobbs_110hp) / 3600.0;
    # tenths of hour
